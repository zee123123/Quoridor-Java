...
public class MenueWindow {
	...
	public static void showWindow() {
		...
		lblNewLabel.setIcon(new ImageIcon("G:\\MUN\\Fall 2020\\comp 2005\\Group project\\Working files\\New folder\\test02\\testRunQuoridor02\\Quoridor2.jpg"));
		lblNewLabel.setBounds(0, 0, 686, 700);
		...
		JButton btnNewButton_1 = new JButton("Load Game"); //button to load the game. (still not implemented).
