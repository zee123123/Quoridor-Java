...
public class PosButton extends JButton{
	public static final int LONG_SIDE = 50;  // the long side
	public static final int SHORT_SIDE = 25; // the short side
	...
	public PosButton(int x,int y,MainWindow mw){
		...
		paintColor();
		// caculate the position of pawns
